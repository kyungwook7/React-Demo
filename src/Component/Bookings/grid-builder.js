...
export function getGrid(bookable, startDate) {
    ...
    const grid = {}
        ...
        // 키 이름과 변수명이 같으면  생략해서 하나만 써도 된다.
        return { grid,      //reid: grid
                 dates,
...
// 자바 스크립트 프로퍼티 get/set 할 때, 객체.프로퍼티이름 또는 객체[프로퍼티이름]
